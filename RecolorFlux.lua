...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	PresetColor = mainclr or Color3.fromRGB(66, 255, 134)
	local fs = false
	...
	BottomText.Position = UDim2.new(0.22, 0, 0.1, 0)
	...
	backuigrown.Color = Color3.fromRGB(0,180,119)
	...
	function Flux:Notification(desc,buttontitle)
		...
		NotificationBase.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(78, 219, 139)
	...
	function Tabs:Tab(text,ico)
		...
		Tab.MouseEnter:Connect(function()
			TweenService:Create(
				...
				{BackgroundColor3 = Color3.fromRGB(78, 219, 139)}
			):Play()
		end)
		...
		function ContainerContent:Button(text, desc, callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(78, 219, 139)
			Button.ClipsDescendants = true
			Button.Position = UDim2.new(0.110937506, 0, 0.67653507, 0)
			...
			ArrowIco.ImageColor3 = Color3.fromRGB(255,255,255)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if BtnDescToggled == false then
					...
					Button:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Toggle(text, desc,default, callback)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if ToggleDescToggled == false then
					...
					Toggle:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if SliderDescToggled == false then
					...
					Slider:TweenSize(UDim2.new(0, 457, 0, 60), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			Dropdown.MouseButton1Click:Connect(function()
				if DropToggled == false then
					Title.Text = Selected
					Dropdown:TweenSize(UDim2.new(0, 457, 0, FrameSize), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = PresetColor}
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(0, 135, 113)
			...
			ConfirmTitle.Position = UDim2.new(0.32, 0, 0, 0)
			...
			ColorpickerBtn.MouseButton1Click:Connect(function()
				if ColorPickerToggled == false then
					...
					Colorpicker:TweenSize(UDim2.new(0, 457, 0, 138), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = PresetColor}
		...
		function ContainerContent:Textbox(text,desc,callback)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if TextboxDescToggled == false then
					...
					Textbox:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
